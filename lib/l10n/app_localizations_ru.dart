...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get usageGuideText => '• Ваши данные хранятся только на вашем устройстве.\n\n• Рекомендуется регулярно создавать резервные копии для защиты данных в ситуациях, таких как смена устройства.\n\n• Записи с шаблонами не включаются в экспортируемые файлы по соображениям безопасности.\n\n• Vault Word скрывает конфиденциальное содержимое на экране.\n\n• Приложение автоматически блокируется при переходе в фоновый режим.\n\n• Это приложение не использует облачную синхронизацию или внешние серверы.\n\n• Для импорта сначала загрузите подходящий шаблон файла и создавайте записи в соответствии с ним.\n\n• Нажмите и удерживайте запись или коллекцию, чтобы удалить её.';
