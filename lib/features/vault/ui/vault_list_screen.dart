        ...
        children: [
          ...
          _CollectionBar(
            ...
            onDelete: openDeleteCollection,
						onClearDefault: (collection) async {
							await openClearDefaultCollection(collection);
						},
          ),
		  Padding(
...
Future<void> openClearDefaultCollection(VaultCollection collection) async {
  final confirmed = await showDialog<bool>(
    context: context,
    builder: (context) {
      return Dialog(
  ...
  await DatabaseHelper.instance
      .deleteItemsInCollection(collection.id);
...
class _CollectionBar extends StatelessWidget {
  ...
  final Function(VaultCollection) onDelete;
	final Future<void> Function(VaultCollection collection) onClearDefault;
  ...
  if (collection.id == 'default') {
    await onClearDefault(collection);
  } else {
    onDelete(collection);
  }
},
